...
hl.config({
    general = {
        ...
        col = {
            active_border   = catppuccin.red,
            inactive_border = catppuccin.base,
        },
...
hl.bind(mainMod .. " + CTRL + L", hl.dsp.exec_cmd("~/Repos/dotfiles/rofi/powermenu.sh"))
...
hl.bind(mainMod .. " + C", hl.dsp.exec_cmd(screenshot))
hl.bind(mainMod .. " + B", hl.dsp.exec_cmd(browser))
hl.bind(mainMod .. " + E", hl.dsp.exec_cmd(terminal .. " -e " .. fileManager))
hl.bind(mainMod .. " + D", hl.dsp.exec_cmd("vesktop"))
hl.bind(mainMod .. " + W", hl.dsp.exec_cmd('firefox -P "whatsapp" --name WhatsApp --new-window https://web.whatsapp.com'))
