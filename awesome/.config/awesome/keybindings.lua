...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey }, "Tab", function () awful.util.spawn("rofi -show window") end,     {description = "opened windows list", group = "client"}),
    ...
    awful.key({ modkey, "Shift"   }, "[", function () awful.layout.inc(-1) end,                 {description = "select previous", group = "layout"})
)
